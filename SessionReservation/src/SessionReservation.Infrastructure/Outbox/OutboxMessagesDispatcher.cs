...
namespace SessionReservation.Infrastructure.Outbox;
...
public class OutboxMessagesDispatcher: BackgroundService
{
    ...
    protected async override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            SessionReservationDbContext dbContext = scope.ServiceProvider.GetRequiredService<SessionReservationDbContext>();
